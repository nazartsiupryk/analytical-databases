-- ConversationStarSchema script for automated creation of database

-- INITIAL CLEAN UP --
USE master
GO
DROP DATABASE IF EXISTS ConversationStarSchema;
GO

-- Located at C:\Program Files\Microsoft SQL Server\MSSQL15.MSSQLSERVER\MSSQL\DATA
CREATE DATABASE ConversationStarSchema
GO

USE ConversationStarSchema
GO
